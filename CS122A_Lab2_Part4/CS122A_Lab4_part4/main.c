...
void TimerISR(){
    TimerFlag = 1;
    time_elapsed_since_last_packet = time_elapsed_since_last_packet + 1;
}
    ...
    switch(SM_1){
        ...
        case DATA_RECEIVE:
            if(leader){
                ...
                SM_1=DATA_RECEIVE;
                if(time_elapsed_since_last_packet > 300){
                    leader = 1;
    ...
    switch(SM_4){
        case CHECK_LEADER_SWITCH:/*
            if(time_elapsed_since_last_packet<299)
                ...
                leader=0x01;  
            //pin_a_value=PINA;
            //if(time_elapsed_since_last_packet<)
                leader=0x01;
            else
                leader=0x00;*/
            break;
